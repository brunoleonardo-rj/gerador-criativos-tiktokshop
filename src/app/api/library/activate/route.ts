...
export async function POST(request: Request) { return (makeLibraryHandlers({ service: await getLibraryService(), requireSession, enforceSameOrigin })).ACTIVATE(request); }
