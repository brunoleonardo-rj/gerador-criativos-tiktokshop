...
const settings = (apiKey = "sk-ant-secret") => ({ getGenerationSettings: async () => ({ apiKey, model: "claude-test", veoTemplate: "Fala: {{copy_completa}}", updatedAt: new Date("2026-01-01T00:00:00Z") }) });
