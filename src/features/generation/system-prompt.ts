...
- cenario: específico deste criativo, diferente dos demais. Nunca descreva mais de um móvel ou elemento com espelho no mesmo ambiente (ex: não combine "penteadeira" com "espelho de corpo inteiro") — no máximo um espelho por cena, sempre. Cenário com espelho (selfie de espelho) é raro: use no máximo um criativo do lote inteiro com espelho, e só quando fizer sentido genuíno para o produto (ex: maquiagem, styling de cabelo, provar roupa). Na maioria dos criativos, prefira cenário sem espelho.
